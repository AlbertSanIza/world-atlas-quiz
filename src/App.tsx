    ...
    return (
        <main className="fixed inset-0 bg-radial from-slate-700 from-40% to-slate-950">
            ...
            <div className="pointer-events-none absolute top-0 flex w-full items-center justify-between px-6 pt-6">
                <div>
                    <h1 className="w-fit rounded-xl bg-black/20 px-2 py-1 text-6xl font-semibold tracking-tight text-white backdrop-blur-xs text-shadow-lg">
                        World Atlas
                    </h1>
                    {started && !finished && (
                        <div className="rounded-r-xl rounded-b-xl bg-black/20 px-2 py-0 font-mono text-lg font-semibold text-white text-shadow-lg">
